...
# Run ONLY after the C2e pilot clears median C_max/C_min >= 3.0, seals (verify_sealed),
# and writes derived/efilter/pilot_context_clearance.json.
# Paging invalidations are per-endpoint in analysis (not run-fatal for clearance).
...
# admissible fraction stated next to every timing-derived number).
