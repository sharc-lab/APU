...
# Paging invalidations are recorded per block (paging_admissible) and are NOT run-fatal.
# Non-paging canary/memory-floor invalidations inside timed blocks still refuse clearance.
