...
Framing note: the five claims below are Paper 2 (DSE) contributions. Paper 1's contributions are the two-axis hardware characterization and joint feasibility envelope; see docs/PAPER_OUTLINE.md.
